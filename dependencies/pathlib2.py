...
# Sublime has no scandir, and it's not used, this borks this module for most purposes, but not for the parsing of the root path/drive, which we need it for
#
#try:
...
class _NormalAccessor(_Accessor):
    ...
    scandir =  False # Intentionally removed, so at import _wrap_strfunc(os_scandir)
